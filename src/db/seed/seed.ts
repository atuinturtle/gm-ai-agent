...
async function seed() {
    await db.insert(playbooks).values([
        { name: 'Cutter', description: 'A dangerous and intimidating fighter' },
        { name: 'Hound', description: 'A deadly sharpshooter and tracker' },
        { name: 'Leech', description: 'A saboteur and technician' },
        { name: 'Lurk', description: 'A stealthy infiltrator and burglar' },
        { name: 'Slide', description: 'A subtle manipulator and spy' },
        { name: 'Spider', description: 'A devious mastermind' },
        { name: 'Whisper', description: 'An arcane adept and channeler' },
    ]).onConflictDoNothing();

    await db.insert(attributes).values([
        { name: 'Insight', description: 'A physical powerhouse' },
        { name: 'Prowess', description: 'A clever and resourceful strategist' },
        { name: 'Resolve', description: 'A resilient and determined fighter' },
    ]).onConflictDoNothing();
